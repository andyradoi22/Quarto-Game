...
#include "../Quarto/BoardStateChecker.h"
#include "../Quarto/BoardStateChecker.cpp"
...
namespace QuartoTests
{
	...
	public:
		...
		TEST_METHOD(NoneLineOne)
		{
			...
			board[{0, 2}] = Piece(Piece::Body::Full, Piece::Color::Light, Piece::Height::Tall, Piece::Shape::Square);
